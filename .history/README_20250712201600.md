...
- Forecasts are saved to forecast_log.csv per session — cities are appended until the app is restarted
- Errors like typos, bad city names, and API issues are handled with user-friendly messages
- No hardcoded secrets — .env keeps your API key safe and out of version control
